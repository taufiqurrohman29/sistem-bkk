                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-10">
                                        <p class="text-left">
                                            <a class="btn btn-sm btn-primary active" href="<?php echo base_url(); ?>pegawai/tambah_loker">
                                                <span class="icon">
                            ...
                            <table class="table table-striped table-bordered" id="table_id">
                                ...
                                <?php foreach($loker as $l) :  ?>
                                    <tr>
                                        ...
                                        <td>
                                                <a href="<?php echo base_url('pegawai/edit_loker/'.$l->id_loker); ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="<?php echo base_url('pegawai/delete_loker/'.$l->id_loker); ?>" class="btn btn-danger btn-circle btn-sm">
