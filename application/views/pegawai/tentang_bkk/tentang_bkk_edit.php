            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    ?>
                        ...
                        <form method="POST" action="<?php echo base_url(); ?>pegawai/update_tentang_bkk/<?php echo $tb->id_tentang_bkk ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="text-right">
                                        ...
                                        <a class="btn btn-space btn-outline-primary" href="<?php echo base_url(); ?>pegawai/tentang_bkk">Kembali</a>
                                    </p>
                                </div>
                            </div>
                        </form>
