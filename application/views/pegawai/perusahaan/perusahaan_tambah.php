            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="card">
                    ...
                    ?>
                        ...
                        <?php echo form_open_multipart('pegawai/tambah_perusahaan_aksi'); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="text-right">
                                        ...
                                        <a class="btn btn-space btn-outline-primary" href="<?php echo base_url(); ?>pegawai/perusahaan">Kembali</a>
                                    </p>
                                </div>
                            </div>
                        <?php echo form_close(); ?>
