                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    <div class="col-sm-8">
                                        <p class="text-left">
                                            <a class="btn btn-sm btn-primary active" href="<?php echo base_url(); ?>pegawai/tambah_tahun">
                                                <span class="icon">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="<?php echo base_url('pegawai/edit_tahun/'.$t->id_tahun); ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="<?php echo base_url('pegawai/delete_tahun/'.$t->id_tahun); ?>" class="btn btn-danger btn-circle btn-sm">
