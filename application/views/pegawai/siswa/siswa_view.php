                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    <div class="col-sm-12">
                                        <p class="text-left">
                                            <a class="btn btn-sm btn-danger active" href="<?php echo base_url(); ?>pegawai/print_siswa">
                                                <span class="icon">
                                                <i class="fa fa-print"></i>
                                                </span>
                                            Print</a>
                                            <a class="btn btn-sm btn-warning active" href="<?php echo base_url(); ?>pegawai/pdf_siswa">
                                                <span class="icon">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="<?php echo base_url('pegawai/edit_siswa/'.$s->id_siswa); ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="<?php echo base_url('pegawai/detail_siswa/'.$s->id_siswa); ?>" class="btn btn-primary btn-circle btn-sm">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="<?php echo base_url('pegawai/delete_siswa/'.$s->id_siswa); ?>" class="btn btn-danger btn-circle btn-sm">
