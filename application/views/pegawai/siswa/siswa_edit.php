    ...
    <div class="container-fluid">
                <div class="card">
                    ...
                    <?php foreach ($siswa as $s) { ?>
                        <form method="POST" action="<?php echo base_url(); ?>pegawai/update_siswa">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin" type="text" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="text-right">
                                        ...
                                        <a class="btn btn-space btn-outline-primary" href="<?php echo base_url(); ?>pegawai/siswa">Kembali</a>
                                    </p>
                                </div>
                            </div>
                            <?php } ?>
