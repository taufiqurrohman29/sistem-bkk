            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('pegawai/print_siswa_persentase?tahun='.$_POST['id_tahun']) ?>" class="btn btn-primary btn-sm float-right" target="__blank"><i class="fa fa-print"></i> Print</a>
                    </div>
                    <div class="card-body">
