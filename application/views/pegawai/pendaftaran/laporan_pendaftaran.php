                       ...
                       <div class="row">
                           ...
                           <div class="col-lg-2">
                               <select name="status" class="form-control">
                                   ...
                                   <option value="2" <?= set_value('status') == '2' ? 'selected' : '' ?>>Tidak seleksi</option>
                               </select>
                           </div>
                           <div class="col-lg-2">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('pegawai/print_pendaftaran/'. $_POST['tanggal1'] . '/' . $_POST['tanggal2'] . '/' . $_POST['status']) ?>" class="btn btn-primary btn-sm float-right" target="__blank"><i class="fa fa-print"></i> Print</a>
                    </div>
                    <div class="card-body">
