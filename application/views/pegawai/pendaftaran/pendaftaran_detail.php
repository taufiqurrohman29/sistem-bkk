    ...
    <div class="alert alert-success" role="alert">
        ...
        <!-- pageheader -->
                ...
                <div class="card">
                    ...
                    ?>
                <form method="POST" action="<?php echo base_url(); ?>pegawai/pendaftaran">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($pdf->status == 0 ) {
                                    ...
                                    $status = "Belum Lolos Seleksi";
                                }
                                ?>
                                <input class="form-control" id="inputdefault" type="text" name="status" value="<?php echo $status ?>" required disabled>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="text-right">
                                        <a class="btn btn-space btn-outline-primary" href="<?php echo base_url(); ?>pegawai/pendaftaran">Kembali</a>
                                    </p>
                                </div>
                            </div>
                            <?php } ?>
