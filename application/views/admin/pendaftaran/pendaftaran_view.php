                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <p class="text-left">
                                            <a class="btn btn-sm btn-primary active" href="<?php echo base_url(); ?>admin/tambah_pendaftaran">
                                                <span class="icon">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="<?php echo base_url('admin/edit_pendaftaran/'.$pdf->id_pendaftaran); ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="<?php echo base_url('admin/detail_pendaftaran/'.$pdf->id_pendaftaran); ?>" class="btn btn-primary btn-circle btn-sm">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="<?php echo base_url('admin/delete_pendaftaran/'.$pdf->id_pendaftaran); ?>" class="btn btn-danger btn-circle btn-sm">
