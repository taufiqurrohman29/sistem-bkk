                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-10">
                                        <p class="text-left">
                                            <a class="btn btn-sm btn-primary active" href="<?php echo base_url(); ?>admin/tambah_pengumuman">
                                                <span class="icon">
                            ...
                            <table class="table table-striped table-bordered" id="table_id">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-gray-900">Juduk</th>
                                ...
                                <?php foreach($pengumuman as $pu) :  ?>
                                    ...
                                    <tr>
                                      ...
                                      <td class="text-gray-800 small">
                                        ...
                                        <td>
                                                <a href="<?php echo base_url('admin/edit_pengumuman/'.$pu->id_pengumuman); ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="<?php echo base_url('admin/delete_pengumuman/'.$pu->id_pengumuman); ?>" class="btn btn-danger btn-circle btn-sm">
