...
function update_siswa(){
    ...
    public function update_jurusan(){
        ...
        else
        {
            ...
            redirect('admin/edit_jurusan/'.$this->input->post('id'), 'refresh');
        }
    }
    ...
    public function edit_loker($id) {
        ...
        $data['perusahaan'] = $this->loker_model->tampil_data('perusahaan')->result();
        $this->load->view('admin/loker/loker_edit',$data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function edit_pengumuman($id) {
        ...
        $this->load->view('admin/pengumuman/pengumuman_edit',$data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function laporan_siswa_persentase(){
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/sidebar',$data);
        $this->load->view('admin/siswa/laporan_siswa_persentase');
        $this->load->view('templates_admin/footer');       
    }
    ...
    public function laporan_perusahaan(){
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/sidebar',$data);
        $this->load->view('admin/perusahaan/laporan_perusahaan');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function laporan_pendaftaran(){
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/sidebar',$data);
        $this->load->view('admin/pendaftaran/laporan_pendaftaran');
        $this->load->view('templates_admin/footer');
    }
